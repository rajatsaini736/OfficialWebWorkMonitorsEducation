...
<div class="jumbotron">
  ...
  <p class="lead">Delhi Police SSC CPO Exam is a great exam for candidates who want to join best paramilitary forces of India (CRPF, BSF, CISF, ITBP and SSB) as Sub-inspectors and Assistant sub-inspector in CISF. These exams are conducted under SSC Central Police Organisation (CPO) process.</p>



  <h3 class="best">SSC CPO Exam Pattern</h3>
  <p class="lead">SSC CPO exam will consis of Paper-I, Physical Standard Test (PST)/Physical Endurance Test (PET), Paper-II and Detailed Medical Examination (DME).</p>
