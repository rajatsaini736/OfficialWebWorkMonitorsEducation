...
$database = "defenceguru_monitors";


if(!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['mobile']) && !empty($_POST['password']) && !empty($_POST['cpassword']) && !empty($_POST['Signup']) ){
  ...
  $mobile = $_POST['mobile'];
    ...
    if($check==0)
    { 
      $sq = "INSERT INTO `user_info` (`name`,`email`,`password`,`mobile`) VALUES ('$name','$email','$password','$mobile')";
