...
<div class="jumbotron">
  ...
  <h3 class="best">RPSC 1st Grade Teacher Examp Pattern</h3>
  <p class="best-txt">RPSC (rajasthan public service commision) organise 1st grade teacher exam for lecturer posts Name of Organization is Rajasthan Public Service Commission (RPSC). Job role is school lecturer (1st grade teacher). Type of job is rajasthan state government jobs.</p>
...
<h3 class="best">RPSC Grade 1st Exam Pattern Paper II</h3>
  <table class="ras-table">
    ...
    <tr>
      <td>Knowledge of Subject Concerned in Senior Secondary Leve</td>
      <td>55</td>
      <td>110</td>
    </tr>
    <tr>
