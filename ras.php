...
<div class="jumbotron">
  ...
  <table class="ras-table">
    ...
    <h3 class="best">RPCS RAS selection process</h3>
    <h3 class="sub-head">Preliminary Exam : </h3>
    <p class="best-txt">&rarr; This is an objective-type screening exam of 200 marks. Candidates needed to complete the paper in 3 hours duration.</p>

    <h3 class="sub-head">Main exam : </h3>
    <p class="best-txt">&rarr; This is a descriptive/ analytical-type written exam. The exam contains 4 papers of 200 marks each. The time allowed to complete each paper is 4 hours.</p>
