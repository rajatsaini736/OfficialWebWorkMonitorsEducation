...
<div class="jumbotron">
  ...
  <p class="best-txt">RPSC organise LDC exam for the post of Lowe Division Clerk. The exam is based on objective type questions. Maximum marks of this exam is 100 and there are 150 total number of questions.</p>

<h3 class="best">Paper 1 (Duration 180 minutes)</h3>
  <table class="ras-table">
    <tr>
      <th style="text-align: left;">Exam Paper Sections</th>
      <th style="text-align: left;">Total Quetion</th>
